...
whileBusca:
    ...
    movq enderecoMaior, %rax
    movq %rax, enderecoBusca ## Aqui passamos da BRK, portanto, movo o maior endereco para o de busca, a fim de retorno
    jmp fimBusca
elseWhileBusca1:
    ...
    movq $0, %rbx
    cmpq %rbx, %rax
    jne fimWhileBusca     # // if(heapHipotetica[enderecoBusca - 2] == 0) { // Bloco atual esta livre
    movq enderecoBusca, %rax
    movq %rax, enderecoMaior
    jmp whileBusca
fimWhileBusca:
    movq enderecoMaior, %rax
    movq $0, %rbx
